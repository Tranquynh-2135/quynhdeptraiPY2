...
class PhotoAPIView(views.APIView):
    ...
    def post(self, request):
        # Kiểm tra nếu không có hình ảnh trong request
        ...
        if request.method == 'POST':
            ...
            if not images:  # Kiểm tra nếu danh sách hình ảnh trống
                return custom_response('No images to upload', 'Error', None, 400)
